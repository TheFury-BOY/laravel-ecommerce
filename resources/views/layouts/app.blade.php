...
<head>
    ...
    <!-- FontAwesome core -->
    <link href="{{ asset('lib/fontawesome-5.11.2/css/all.min.css') }}" rel="stylesheet">
...
<body>
        ...
        <header class="blog-header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                <div class="col-4 pt-1">
                    <a class="text-muted" href="{{ route('carts.index') }}"><i class="fas fa-cart-arrow-down"></i> Panier <span class="badge badge-pill badge-dark">{{ Cart::count() }}<!--Retourne le nombre d'article dans le panier--></span></a>
                </div>
                <div class="col-4 text-center">
                    <a class="blog-header-logo text-dark" href="{{ route('products.index') }}"><i class="fas fa-shopping-cart text-lg"></i> E-commerce</a>
                </div>
    ...
    <footer class="blog-footer">
        <p>Ecommerce template built by <a
                href="https://github.com/TheFury-BOY">TheFury-BOY</a>.</p>
        <p>
